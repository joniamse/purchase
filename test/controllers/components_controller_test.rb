...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post components_url, params: { component: { model: @component.model, rgb: @component.rgb, serial_number: @component.serial_number, type: @component.type } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { model: @component.model, rgb: @component.rgb, serial_number: @component.serial_number, type: @component.type } }
